...
internal class Camera
{
    ...
    public Vector3 Up { get; private set; } = new(0.0f, 1.0f, 0.0f);
    ...
    public void MoveLeft(float dt) => Position -= Right * (MovementSpeed * dt);
    public void MoveRight(float dt) => Position += Right * (MovementSpeed * dt);
