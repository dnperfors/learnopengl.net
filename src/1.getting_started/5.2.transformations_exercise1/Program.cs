...
unsafe void OnRender(double dt)
{
    ...
    trans *= Matrix4x4.CreateTranslation(0.5f, -0.5f, 0.0f);
    trans *= Matrix4x4.CreateRotationZ((float)Glfw.GetApi().GetTime());

    // { {M11:-0.44807363 M12:0.89399666 M13:0 M14:0} {M21:-0.89399666 M22:-0.44807363 M23:0 M24:0} {M31:0 M32:0 M33:1 M34:0} {M41:0.5 M42:-0.5 M43:0 M44:1} }
    // { {M11:-0.44807363 M12:0.89399666 M13:0 M14:0} {M21:-0.89399666 M22:-0.44807363 M23:0 M24:0} {M31:0 M32:0 M33:1 M34:0} {M41:0.22296152 M42:0.6710352 M43:0 M44:1} }
    // The calculations are in the wrong order, the "Z" axis is no longer "reset"

    var location = gl.GetUniformLocation(shaderProgram.ProgramId, "transform");
    gl.UniformMatrix4(location, 1, false, (float*)&trans);
